...
Sequence(
    ...
    rshuffle(
        pick("test_ConceptualMatch_Physical", 5),
        pick("test_ConceptualMatch_Psychological", 5),
        ...
        pick("control_MaxMatch_Negative_Physical", 5),
        pick("control_MaxMatch_Negative_Psychological", 5),
        pick("control_MaxMatch_Positive_Physical", 5),
        pick("control_MaxMatch_Positive_Psychological", 5),
