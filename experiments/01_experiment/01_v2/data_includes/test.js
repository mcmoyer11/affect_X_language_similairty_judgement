Template(GetTable("v2_ValenceMatchingOnly_Positive.csv"),
    
    row => newTrial("test_ValenceMatch_Positive",
...
Template(GetTable("v2_ValenceMatchingOnly_Negative.csv"),
    
    row => newTrial("test_ValenceMatch_Negative",
...
Template(GetTable("v2_ConceptualMatchingOnly_Physical.csv"),
    
    row => newTrial("test_ConceptualMatch_Physical",
...
Template(GetTable("v2_ConceptualMatchingOnly_Psychological.csv"),
    
    row => newTrial("test_ConceptualMatch_Psychological",
