...
Template(GetTable("v2_MaxMismatch.csv"),
...
Template(GetTable("v2_MaxMatch_Negative_Physical.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Physical",
...
Template(GetTable("v2_MaxMatch_Positive_Physical.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Physical",
...
Template(GetTable("v2_MaxMatch_Negative_Psychological.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Psychological",
...
Template(GetTable("v2_MaxMatch_Positive_Psychological.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Psychological",
