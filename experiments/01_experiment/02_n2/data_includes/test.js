Template(GetTable("n2_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("n2_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("n2_ConceptualMatchingOnly_Animate.csv"),
    
    row => newTrial("test_ConceptualMatch_Animate",
...
Template(GetTable("n2_ConceptualMatchingOnly_Inanimate.csv"),
    
    row => newTrial("test_ConceptualMatch_Inanimate",
