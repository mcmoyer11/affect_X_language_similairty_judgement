...
Template(GetTable("n2_MaxMismatch.csv"),
...
Template(GetTable("n2_MaxMatch_Negative_Animate.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Animate",
...
Template(GetTable("n2_MaxMatch_Positive_Animate.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Animate",
...
Template(GetTable("n2_MaxMatch_Negative_Inanimate.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Inanimate",
...
Template(GetTable("n2_MaxMatch_Positive_Inanimate.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Inanimate",
