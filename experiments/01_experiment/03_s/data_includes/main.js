...
Sequence(
    ...
    rshuffle(
        pick("test_ConceptualMatch_Noun", 5),
        pick("test_ConceptualMatch_Verb", 5),
        ...
        pick("control_MaxMatch_Negative_Noun", 5),
        pick("control_MaxMatch_Negative_Verb", 5),
        pick("control_MaxMatch_Positive_Noun", 5),
        pick("control_MaxMatch_Positive_Verb", 5),
