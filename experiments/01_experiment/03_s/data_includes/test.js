Template(GetTable("s_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("s_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("s_ConceptualMatchingOnly_Noun.csv"),
    
    row => newTrial("test_ConceptualMatch_Noun",
...
Template(GetTable("s_ConceptualMatchingOnly_Verb.csv"),
    
    row => newTrial("test_ConceptualMatch_Verb",
