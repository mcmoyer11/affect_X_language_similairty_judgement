Template(GetTable("v_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("v_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("v_ConceptualMatchingOnly_Concrete.csv"),
    
    row => newTrial("test_ConceptualMatch_Concrete",
...
Template(GetTable("v_ConceptualMatchingOnly_Abstract.csv"),
    
    row => newTrial("test_ConceptualMatch_Abstract",
