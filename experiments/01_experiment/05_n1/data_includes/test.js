Template(GetTable("n_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("n_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("n_ConceptualMatchingOnly_Concrete.csv"),
...
Template(GetTable("n_ConceptualMatchingOnly_Abstract.csv"),
