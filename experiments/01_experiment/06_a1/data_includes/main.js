...
Sequence(
    ...
    rshuffle(
        pick("test_ConceptualMatch_Concrete", 5),
        pick("test_ConceptualMatch_Abstract", 5),
        ...
        pick("control_MaxMatch_Negative_Concrete", 5),
        pick("control_MaxMatch_Negative_Abstract", 5),
        pick("control_MaxMatch_Positive_Concrete", 5),
        pick("control_MaxMatch_Positive_Abstract", 5),
