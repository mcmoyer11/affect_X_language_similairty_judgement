Template(GetTable("a_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("a_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("a_ConceptualMatchingOnly_Concrete.csv"),
...
Template(GetTable("a_ConceptualMatchingOnly_Abstract.csv"),
