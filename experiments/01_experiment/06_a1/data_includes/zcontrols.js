...
Template(GetTable("a_MaxMismatch.csv"),
...
Template(GetTable("a_MaxMatch_Negative_Concrete.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Concrete",
...
Template(GetTable("a_MaxMatch_Positive_Concrete.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Concrete",
...
Template(GetTable("a_MaxMatch_Negative_Abstract.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Abstract",
...
Template(GetTable("a_MaxMatch_Positive_Abstract.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Abstract",
