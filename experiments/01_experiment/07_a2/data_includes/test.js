Template(GetTable("a2_ValenceMatchingOnly_Positive.csv"),
...
Template(GetTable("a2_ValenceMatchingOnly_Negative.csv"),
...
Template(GetTable("a2_ConceptualMatchingOnly_Physical.csv"),
...
Template(GetTable("a2_ConceptualMatchingOnly_Social.csv"),
    
    row => newTrial("test_ConceptualMatch_Social",
