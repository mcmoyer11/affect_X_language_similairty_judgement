...
Template(GetTable("a2_MaxMismatch.csv"),
...
Template(GetTable("a2_MaxMatch_Negative_Physical.csv"),
...
Template(GetTable("a2_MaxMatch_Positive_Physical.csv"),
...
Template(GetTable("a2_MaxMatch_Negative_Social.csv"),
    
    row => newTrial("control_MaxMatch_Negative_Social",
...
Template(GetTable("a2_MaxMatch_Positive_Social.csv"),
    
    row => newTrial("control_MaxMatch_Positive_Social",
